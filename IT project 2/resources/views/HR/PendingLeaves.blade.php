                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    {{--@foreach ($employeeleaveledger as $emp_id)--}}
                                        {{--<tr>--}}
                                            {{--<td>{{ $employeedataf->givenname.' '.substr($employeedataf->middlename,1). ' '.$employeedataf->lastname}}</td>--}}
                                            {{--<td>{{$emp_id->inclusiveDates}}</td>--}}
                                            {{--<td>{{ $employeedataf->typeOfLeave}}</td>--}}
                                            {{--<td>{{$emp_id->dateOfapplication}}</td>--}}
