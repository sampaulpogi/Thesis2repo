                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $i = 0;
                                    $months = [];
                                    $vacationAvailedLeaves = [];
                                    $vacationNoOfAbsences = [];
                                    $tardiness = [];
                                    $vacationEarned = [];
                                    $vacationBalance = [];
                                    $vacationAbsencesWithPay = [];
                                    $vacationAbsencesWithoutPay = [];
                                    $sickAvailedLeaves = [];
                                    $sickNoOfAbsences = [];
                                    $sickEarned = [];
                                    $sickBalance = [];
                                    $sickAbsencesWithPay = [];
                                    $sickAbsencesWithoutPay = [];
                                    $year = [];
...
//                                        $vacationAbsencesWithoutPay[] = $emp_id->vacationAbsencesWithoutPay;
                                    ...
                                    <tr>
                                        <td>JAN</td>
                                        <td> {{$vacationAvailedLeaves[0]}}</td>
                                        <td>{{$vacationNoOfAbsence[0]}}</td>
                                        <td>{{$vacationEarned[0]}}</td>
                                        <td>{{$vacationBalance[0]}}</td>
                                        <td>{{$vacationAbsencesWithPay[0]}}</td>
                                        <td>{{$vacationAbsencesWithoutPay[0]}}</td>
                                    </tr>
                                    <tr>
                                        <td>FEB</td>
                                        <td>15 SPL</td>
